...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || process.env.SITE_ORIGIN || 'http://localhost:3000'),
  icons: {
    icon: [
  ...
  return (
    ...
    >
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800;900&family=Inter:wght@400;500;600;700;800;900&family=Montserrat:wght@400;500;600;700;800;900&family=Outfit:wght@400;500;600;700;800;900&display=swap"
          rel="stylesheet"
        />
