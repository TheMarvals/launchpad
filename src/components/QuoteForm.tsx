      ...
      <div className="bg-canvas-elevated border border-hairline p-sm space-y-sm">
        ...
        <div className="space-y-sm border-t border-hairline pt-sm">
          {items.map((item: any, idx: number) => (
            <div key={idx} className="bg-canvas border border-hairline p-sm space-y-xs relative">
              {/* Description - 100% width */}
              <div className="space-y-xxs">
                <label className="block text-caption-uppercase text-ink font-semibold">{t('itemLabel')}</label>
                <textarea 
              ...
              <div className="flex flex-wrap items-center justify-between gap-sm pt-xs border-t border-hairline/20">
                <div className="flex gap-sm">
                  ...
                  <div className="w-36 space-y-xxs">
                    <label className="block text-caption-uppercase text-ink font-semibold">{t('unitPrice')}</label>
                    <div className="relative">
                ...
                <div className="flex items-center gap-md self-end pb-[2px]">
                  <div className="text-right">
                    <div className="text-caption-uppercase text-muted text-[10px] mb-0">{t('subtotal')}</div>
